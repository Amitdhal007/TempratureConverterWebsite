const inputs = document.querySelectorAll(".converter-box input");
const c = document.querySelector("#celsius-value");
const f = document.querySelector("#fahrehite-value");
const k = document.querySelector("#kelvin-value");
